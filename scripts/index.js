...
class signalement {constructor(id,latitude,longitude,marqueur,evenement,date,utilisateur,note){
	this.id = id;
...
function createMap() {
	...
	// function(event){
			// console.log(" nouveau centre : "+event.latLng.lat()+" "+ event.latLng.lng());	
	// });
